...
class array:
    def __init__(self, capacity):
        ...
        self.count = 0  # Current size
        self.elements = [None] * capacity  # A series of empty cells
...
def resize_array(array):
    ...
    # Copy elements from passed-in array
...
def array_read(array, index):
    ...
    if index >= array.count:
        print('Error out of bounds [array_read]')
        return None
...
def array_remove(array, element):
    ...
    if removed:
        ...
        print('Error element not found [array_remove]')
